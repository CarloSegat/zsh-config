---
name: local-mistral
description: Mistral Large 123b on the TU Berlin Ollama server via the local gateway, zero token cost. Arena runner, cross-judge or plan critic; only reachable from a claude-gw session.
