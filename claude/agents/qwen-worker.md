---
name: qwen-worker
description: Cheap worker on the TU Berlin qwen3.8-flash-next model via the local gateway. Use for mechanical tasks (file listing, reading, grepping, small edits).
model: qwen3.8-flash-next:125b-a6b-q8_0
