...
description: "Read-only question: how does X work, why was Y built this way, are we sure about Z, should we do X or Y. Produces a cited explanation or recommendation, not a code change."
---
